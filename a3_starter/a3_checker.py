...
SAMPLE_DATA_WITH_NUM_MUTUALS = {
    ...
    "username4": {
        ...
        NUM_COMMENTS: 1,
        ACCOUNT_CREATED: "2023-01-01",
        FOLLOWERS: ["username1", "username2", "username3", "username5"],
        FOLLOWING: [],
        BOT_GROUPS: [],
        NUM_MUTUALS: 0
    },
...
class TestChecker(unittest.TestCase):
    ...
    def test_order_bot_candidates(self) -> None:
        ...
        result = checker.returns_list_of(data_analyst.order_bot_candidates, [SAMPLE_DATA], str)
